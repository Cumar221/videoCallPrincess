...
//  videoCallPrincess
//
//  Created by Colter Conway on 1/20/18.
...
class VideoViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
  ...
  override func viewDidLoad() {
    ...
    playSound(soundFile: "outboundRingTone", soundFileType: "mov")
    
    DispatchQueue.main.asyncAfter(deadline: .now() + 6.5) { // change 2 to desired number of seconds
